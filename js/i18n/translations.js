...
const I18n = (() => {
    ...
    const translations = {
        en: {
            ...
            'settings.control_mode': 'Touch Controls',
            'settings.joystick': '🕹️ Joystick',
            'settings.dpad': '✚ D-Pad',
            'settings.control_mode_hint': 'Mobile only',
            ...
            'stats.next_rank': 'Next: {0} — {1} donuts to go',
            'stats.max_rank': 'Max rank achieved! 👑',
            ...
            'stats.lifetime_stats': '📈 Lifetime Stats',
            'stats.best_by_difficulty': '🏅 Best Score by Difficulty',
            'stats.rank_progression': '🎖️ Rank Progression',
            ...
            'daily.share_result': '📤 Share Result',
            'daily.completed': '✅ Completed',
            'daily.time_limit': '⏱️ {0}s time limit',
            'daily.ghost_target': '👻 Eat {0}+ ghosts',
            'daily.no_deaths': '✨ No deaths allowed',
            'daily.no_powerups': '🚫 Power-ups disabled',
            'daily.donut_spawns': '🍩 {0}x donut spawns',
            'daily.score_mult': '🏆 {0}x score multiplier',
            'daily.one_life': '💀 1 life only',
            'daily.ghosts_faster': '👻 Ghosts {0}% faster',
            ...
            'daily.share_first': "🥇 I got 1st place on today's challenge!",
            'daily.share_score': '🏆 Score: {0}',
            'daily.share_streak': '🔥 Streak: {0} days',
            'daily.shared': 'Shared! 🎉',
            'daily.result_copied': 'Result copied! 📋',
        },
        ...
        es: {
            ...
            'settings.control_mode': 'Controles Táctiles',
            'settings.joystick': '🕹️ Joystick',
            'settings.dpad': '✚ D-Pad',
            'settings.control_mode_hint': 'Solo móvil',
            ...
            'stats.next_rank': 'Siguiente: {0} — {1} rosquillas más',
            'stats.max_rank': '¡Rango máximo alcanzado! 👑',
            ...
            'stats.highest_level': 'Nivel Más Alto',
            'stats.play_time': 'Tiempo de Juego',
            'stats.lifetime_stats': '📈 Estadísticas Totales',
            'stats.best_by_difficulty': '🏅 Mejor Puntuación por Dificultad',
            'stats.rank_progression': '🎖️ Progresión de Rango',
            ...
            'daily.share_result': '📤 Compartir Resultado',
            'daily.completed': '✅ Completado',
            'daily.time_limit': '⏱️ {0}s de tiempo',
            'daily.ghost_target': '👻 Come {0}+ fantasmas',
            'daily.no_deaths': '✨ Sin muertes permitidas',
            'daily.no_powerups': '🚫 Sin power-ups',
            'daily.donut_spawns': '🍩 {0}x rosquillas',
            'daily.score_mult': '🏆 {0}x puntuación',
            'daily.one_life': '💀 1 vida solamente',
            'daily.ghosts_faster': '👻 Fantasmas {0}% más rápidos',
            'daily.streak': '🔥 ¡{0} días de racha!',
            'daily.share_title': 'Desafío Diario ComeRosquillas',
            'daily.share_text': '{0} Desafío Diario ComeRosquillas: {1}',
            'daily.share_first': '🥇 ¡Quedé primero en el desafío de hoy!',
            'daily.share_score': '🏆 Puntos: {0}',
            'daily.share_streak': '🔥 Racha: {0} días',
            'daily.shared': '¡Compartido! 🎉',
            'daily.result_copied': '¡Resultado copiado! 📋',
        },
        ...
        fr: {
            ...
            'settings.control_mode': 'Contrôles Tactiles',
            'settings.joystick': '🕹️ Joystick',
            'settings.dpad': '✚ D-Pad',
            'settings.control_mode_hint': 'Mobile uniquement',
        ...
        de: {
            ...
            'settings.control_mode': 'Touch-Steuerung',
            'settings.joystick': '🕹️ Joystick',
            'settings.dpad': '✚ D-Pad',
            'settings.control_mode_hint': 'Nur Mobilgerät',
        ...
        'pt-BR': {
            ...
            'settings.control_mode': 'Controles de Toque',
            'settings.joystick': '🕹️ Joystick',
            'settings.dpad': '✚ D-Pad',
            'settings.control_mode_hint': 'Apenas celular',
            'settings.language': '🌐 Idioma',
            'settings.language_label': 'Idioma',
